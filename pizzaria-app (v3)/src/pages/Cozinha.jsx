...
const Cozinha = () => {
  ...
  return (
    <Container maxWidth="lg" sx={{ my: 4 }}>
      <Typography variant="h4" component="h1" gutterBottom>Painel da Cozinha</Typography>
      <Typography color="text.secondary" sx={{ mb: 3 }}>Pedidos aguardando preparação.</Typography>
            ...
            <Grid item xs={12} sm={6} md={4} key={pedido.id}>
              <Card sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
                <CardContent sx={{ flexGrow: 1 }}>
                  <Typography variant="h6" component="h2" gutterBottom>Pedido #{pedido.id.substring(0, 8)}</Typography>
                    ...
                    {pedido.itens.map(item => (
                      <ListItem key={item.idUnicoCarrinho} disableGutters>
                        <ListItemText 
                          ...
                          // Só exibe o tamanho se o item tiver essa propriedade
                ...
                <CardActions sx={{ justifyContent: 'center', p: 2 }}>
                  <Button variant="contained" color="success" startIcon={<RestaurantMenuIcon />} onClick={() => marcarComoPronto(pedido.id)} fullWidth>
                    Pedido Pronto
                  </Button>
                </CardActions>
              </Card>
